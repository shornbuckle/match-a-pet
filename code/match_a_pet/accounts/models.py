...
class User(AbstractUser):
    ...
    shelter_city = models.CharField(max_length=50, default='null')
...
class ShelterUser(models.Model):
    user = models.OneToOneField(User, on_delete=models.CASCADE, primary_key=True)
    shelter_city = models.CharField(max_length=50, default='Brooklyn')
    shelter_state = models.CharField(max_length=50, default='New York')
...
def update_ShelterUser_signal(sender, instance, created, **kwargs):
    if created:
        ShelterUser.objects.create(user=instance)
    instance.shelteruser.save()
"""
